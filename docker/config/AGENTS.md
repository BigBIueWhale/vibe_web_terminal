...
- **Node packages**: puppeteer, playwright, typescript, webpack, esbuild, and 100+ more
- **CLI tools**: git, gh, ripgrep, fd, bat, jq, yq, curl, wget, ffmpeg, imagemagick
- **Browsers**: Chromium and Firefox via Playwright (headless)
